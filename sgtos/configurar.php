                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline">Activar o desactivar o controle de baixa financeira, com data retroativa.</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="control_editos" class="control-label">Controle de edición de la OS</label>
                            <div class="controls">
