                            ...
                            <table class="table table-condensed" id="tblProdutos">
                                ...
                                <tbody>
                                    ...
                                    foreach ($produtos as $p) {
                                        ...
                                        echo '<td style="text-align: center">$' . number_format($p->preco, 2, ',', '.') . '</td>';
                                    ...
                                    foreach ($servicos as $s) {
                                        ...
                                        echo '<td style="text-align: center">' . $p->quantidade . '</td>';
                                        echo '<td style="text-align: center">$ ' . number_format($s->subTotal, 2, ',', '.') . '</td>';
                                        echo '</tr>';
                                    }
                            ?>
                                ...
                                <?php endif ?>                          
                                    <tr>
                                        <td colspan="3" style="text-align: right"></td>
                                        <td style="text-align: center"><strong> Total a Pagar: $
