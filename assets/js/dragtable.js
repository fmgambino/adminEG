(function() {
  ...
  function init() {
    window.document.body.insertAdjacentHTML( 'afterbegin', '<div class="draggable-saved animated"><i class="bx bx-like bx-lg"></i></div>' );
    bindMouse();
  }
  ...
  function bindMouse() {
    ...
    document.addEventListener('mouseup', (event) => {
      ...
      const os = current.attributes['data-os'].value
